...
CRYPTO_PAY_API_BASE_URL = os.getenv("CRYPTO_PAY_API_BASE_URL", "").strip()
CRYPTO_PAY_CHECK_BASE_URL = os.getenv("CRYPTO_PAY_CHECK_BASE_URL", "").strip()
...
# Supplier withdrawals through CryptoBot checks.
WITHDRAWAL_FEE_USD = os.getenv("WITHDRAWAL_FEE_USD", "2.5").strip()
WITHDRAW_AUTO_CRYPTOBOT = os.getenv("WITHDRAW_AUTO_CRYPTOBOT", "1").strip() == "1"
WITHDRAW_PAYOUT_ASSET = os.getenv("WITHDRAW_PAYOUT_ASSET", "USDT").strip().upper()
...
class Settings:
    ...
    CRYPTO_PAY_API_BASE_URL = CRYPTO_PAY_API_BASE_URL
    ...
    WITHDRAW_AUTO_CRYPTOBOT = WITHDRAW_AUTO_CRYPTOBOT
    WITHDRAW_PAYOUT_ASSET = WITHDRAW_PAYOUT_ASSET
